 ...
 * and nobody wants that question about a thousand. Keep the first list-capacity worth,
 * in file order, so this decoder cannot offer more than the reducer accepts.
 */
