...
export function listToJson(list: ListMeta & ListData): string {
  const { title, description, displayUnit, trailUrl, trailLabel, trailDistanceM, trailDistanceUnit, trailProfile, trailAscentM, startDate, endDate, folders, items, days } = list;
  ...
  return JSON.stringify(
    { title, description, displayUnit, trailUrl, trailLabel, trailDistanceM, trailDistanceUnit, trailProfile, trailAscentM, startDate, endDate, folders, items, days },
    null,
    2,
  );
}
