...
// view bump keeps the view_count column current (undercounts under CDN cache —
// acceptable + burst-resistant; nothing sorts on it since the feed went).
// Returns only public fields (no id/token).
