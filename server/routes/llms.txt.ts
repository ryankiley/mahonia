...
export default defineEventHandler((event) => {
  ...
  return [
    ...
    "- [What's new](https://github.com/ryankiley/mahonia/releases): a release per day that ships something",
    `- [Public lists](${origin}/sitemap.xml): every shared public list, at /l/{slug}`,
    `- [Legal](${origin}/legal): privacy policy and terms of use`,
    "",
    "## Catalog",
    "",
    "Every product in the gear catalog has a page at /catalog/{brand}/{product}: each",
    "variant's cited weight in grams and ounces, the maker's own words for it and a link",
    "to the page they were read from. Every page is listed in the sitemap.",
    "",
    `- ${origin}/catalog/durston/x-mid-2: one product's page, for the shape`,
    "",
    "## Shared lists",
    "",
